// src/app/(dashboard)/verifikasi/dinas/verifikasi-dinas-table.tsx
"use client"
...
import DialogVerifikasiDinas from './dialog-verifikasi-dinas'

// Tipe data untuk props (tidak berubah)
interface VerifikasiDinasTableProps {
...
// ===============================================================
export default function VerifikasiDinasTable({ dataPengajuan }: VerifikasiDinasTableProps) {
        ...
        <Table>
          <TableCaption>
            {dataPengajuan.length === 0 
              ? "Tidak ada pengajuan dinas yang perlu diverifikasi." 
              : "Daftar pengajuan dinas yang menunggu verifikasi."
            }
          </TableCaption>
          <TableHeader>
            <TableRow>
