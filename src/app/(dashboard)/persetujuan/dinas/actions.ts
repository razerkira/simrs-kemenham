// src/app/(dashboard)/persetujuan/dinas/actions.ts
...
export async function prosesPersetujuanDinas(
  ...
  const { error } = await supabase
    .from('pengajuan_dinas') // <-- UBAH: tabel 'pengajuan_dinas'
    .update({
      status: statusBaru,
